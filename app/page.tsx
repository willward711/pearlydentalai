      ...
      <section className="relative px-6 pb-16" aria-label="Safety note">
        <div className="mx-auto max-w-2xl rounded-3xl bg-white/10 border border-white/20 backdrop-blur-sm p-6 text-center">
          ...
          <p className="text-sm text-white/80 leading-relaxed">
            Pearly is an educational AI — her answers are generated by artificial intelligence and can contain
            mistakes. She can explain how teeth work and how to care for them, but she can&apos;t examine you,
            diagnose you, or replace a real dentist. Nothing here is a substitute for professional dental advice,
            diagnosis, or treatment. If something hurts or worries you, please see a dental professional — and if
            it might be an emergency, call 911.
          </p>
        </div>
      </section>
